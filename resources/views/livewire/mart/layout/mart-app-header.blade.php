    ...
    <div class="header-top">
        <div class="container">
            ...
            <div class="header-right">
                ...
                <div class="dropdown">
                    <a href="#language"><img src="{{asset('mart/images/flags/eng.png')}}" alt="ENG Flag" width="14"
                                             height="8" class="dropdown-image" /> ENG</a>
                    <div class="dropdown-box">
                        <a href="#ENG">
                            <img src="{{asset('mart/images/flags/eng.png')}}" alt="ENG Flag" width="14" height="8"
                                 class="dropdown-image" />
                            ENG
                        </a>
                        <a href="#FRA">
                            <img src="{{asset('mart/images/flags/fra.png')}}" alt="FRA Flag" width="14" height="8"
                                 class="dropdown-image" />
                            FRA
                        </a>
                    </div>
                ...
                <a href="mart/ajax/login.html" class="d-lg-show login sign-in"><i
                        class="w-icon-account"></i>Sign In</a>
                <span class="delimiter d-lg-show">/</span>
                <a href="mart/ajax/login.html" class="ml-0 d-lg-show login register">Register</a>
            </div>
        </div>
    </div>
    <!-- End of Header Top -->
        ...
        <div class="container">
            <div class="header-left mr-md-4">
                ...
                <a href="demo1.html" class="logo ml-lg-0">
                    <img src="{{asset('mart/images/logo.png')}}" alt="logo" width="144" height="45" />
                </a>
                    ...
                    <div class="dropdown-box">
                        ...
                        <div class="products">
                            <div class="product product-cart">
                                ...
                                <figure class="product-media">
                                    <a href="product-default.html">
                                        <img src="{{asset('mart/images/cart/product-1.jpg')}}" alt="product" height="84"
                                             width="94" />
                                    </a>
                                </figure>
                            ...
                            <div class="product product-cart">
                                ...
                                <figure class="product-media">
                                    <a href="product-default.html">
                                        <img src="{{asset('mart/images/cart/product-2.jpg')}}" alt="product" width="84"
                                             height="94" />
                                    </a>
                                </figure>
                                <button class="btn btn-link btn-close" aria-label="button">
                                    ...
                                    <ul class="megamenu">
                                        ...
                                        <li>
                                            <div class="banner-fixed menu-banner menu-banner2">
                                                <figure>
                                                    <img src="{{asset('')}}mart/images/menu/banner-2.jpg" alt="Menu Banner"
                                    ...
                                    <ul class="megamenu">
                                        ...
                                        <li>
                                            <div class="menu-banner banner-fixed menu-banner3">
                                                <figure>
                                                    <img src="{{asset('mart/images/menu/banner-3.jpg')}}" alt="Menu Banner"
                                    ...
                                    <ul class="megamenu">
                                        ...
                                        <li>
                                            <div class="menu-banner banner-fixed menu-banner4">
                                                <figure>
                                                    <img src="{{asset('mart/images/menu/banner-4.jpg')}}" alt="Menu Banner"
                                        ...
                                        <li class="row">
                                            <div class="col-6">
                                                <div class="banner banner-fixed menu-banner5 br-xs">
                                                    <figure>
                                                        <img src="{{asset('mart/images/menu/banner-5.jpg')}}" alt="Banner"
                                            ...
                                            <div class="col-6">
                                                <div class="banner banner-fixed menu-banner5 br-xs">
                                                    <figure>
                                                        <img src="{{asset('mart/images/menu/banner-6.jpg')}}" alt="Banner"
                                                             width="410" height="123"
