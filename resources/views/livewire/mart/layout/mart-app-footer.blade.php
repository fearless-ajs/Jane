    ...
    <div class="container">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="widget widget-about">
                        <a href="demo1.html" class="logo-footer">
                            <img src="{{asset('mart/images/logo_footer.png')}}" alt="logo-footer" width="144"
                                 height="45" />
                        </a>
        ...
        <div class="footer-bottom">
            <div class="footer-left">
                <p class="copyright">Copyright © {{ now()->year }} {{$settings->app_name}}. All Rights Reserved.</p>
            </div>
            <div class="footer-right">
                <span class="payment-label mr-lg-8">We're using safe payment for</span>
                <figure class="payment">
                    <img src="{{asset('mart/images/payment.png')}}" alt="payment" width="159" height="25" />
                </figure>
            </div>
        </div>
    </div>
